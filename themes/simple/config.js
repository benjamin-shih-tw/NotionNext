const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>用鉛筆與墨水思考的開發者</div>',
  ...
  SIMPLE_COLOR_PRIMARY: '#d5a719',
  SIMPLE_COLOR_TITLE: '#332d1f',
